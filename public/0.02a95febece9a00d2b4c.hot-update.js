	  ...
	  render: function render() {
	    ...
	    return _react3.default.createElement(
	      ...
	      _react3.default.createElement(
	        'li',
	        null,
	        _react3.default.createElement('input', { type: 'text', placeholder: 'Age', onChange: this.onInputChangeAge })
	      ),
	      _react3.default.createElement(
	        'li',
	        null,
	      ...
	      _react3.default.createElement(
	        'li',
	        null,
	        _react3.default.createElement('input', { type: 'text', placeholder: 'State', onChange: this.onInputChangeState })
	      ),
	      _react3.default.createElement(
	        'li',
	        null,
	        _react3.default.createElement('input', { type: 'text', placeholder: 'Country', onChange: this.onInputChangeCountry })
	      ),
	      _react3.default.createElement(
	        'li',
	        null,
