	    ...
	    return _react3.default.createElement(
	      ...
	      _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          ...
	          _react3.default.createElement(
	            'button',
	            { onClick: this.clickedMe, id: 'btn2', value: 'A+' },
	            'A+'
	          ),
	          _react3.default.createElement(
	            'button',
	            { onClick: this.clickedMe, id: 'btn3', value: 'A-' },
	            'A-'
	          ),
	          _react3.default.createElement(
	            'button',
	            { onClick: this.clickedMe, id: 'btn4', value: 'B+' },
	            'B+'
	          ),
	          _react3.default.createElement(
	            'button',
	            { onClick: this.clickedMe, id: 'btn5', value: 'B-' },
	            'B-'
	          ),
	          _react3.default.createElement(
	            'button',
	            { onClick: this.clickedMe, id: 'btn6', value: 'AB+' },
	            'AB+'
	          ),
	          _react3.default.createElement(
	            'button',
	            { onClick: this.clickedMe, id: 'btn7', value: 'AB-' },
	            'AB-'
	          )
	        )
	      )
